...
<input class="btn btn-danger mt-3" type="submit" value="Print" onClick="window.print()"></form>
<form action="work.php" class="mb-3 d-print-none d-inline"><input class="btn btn-secondary mt-3" type="submit" value="Close" >
</form>
</div>
